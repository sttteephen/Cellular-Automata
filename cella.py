...
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
ARRAY_SIZE = WIN_WIDTH // CELL_WIDTH
...
def new_genaration(array, ruleset):
    ...
    # loop over cells in the current genaration
...
# get rule from use (try 90, 182, 30, 165, 57, 45, 110, 73)
ruleint = -1
while ruleint < 0 or ruleint > 255:
    print("(try 90, 182, 30, 165, 57, 45, 110, 73)")
